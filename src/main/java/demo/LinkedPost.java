...
public class LinkedPost {
    ...
    public void testCase01() throws InterruptedException {
        ...
        SignIn.click();
        Thread.sleep(5000);
        WebElement messagebutton = driver
                .findElement(By.xpath("//div[@class='msg-overlay-bubble-header__controls display-flex']/button[2]"));
        messagebutton.click();
        ...
        startpost.click();
        // click on button post to anyone Using Locator "XPath"
        // //button[@class='share-unified-settings-entry-button']
        ...
        // send keys Using Locator "XPath" //div[@class='ql-editor ql-blank']/This is a
        // test post
        ...
        postbutton.click();
        // Click on Who's viewed your profile Using Locator "XPath"
        // //a[@href='/me/profile-views/']
        WebElement views = driver.findElement(By.xpath("//a[@href='/dashboard/']"));
        views.click();
        // get text of element displaying the number of views Using Locator "XPath"
        // //p[@class='text-body-medium-bold pr1 text-heading-large']
        WebElement numberofviews = driver.findElement(By.xpath(
                "//a[@href='https://www.linkedin.com/me/profile-views']//div[@class='pcd-analytics-view-item']//p"));
        String numviews = numberofviews.getText();
        System.out.println("Number of views " + numviews);

        // Click on Impressions of your post Using Locator "XPath"
        // //a[@href='/in/vikram-singh-037305126/recent-activity/shares/']
        WebElement impressions = driver.findElement(By.xpath(
                "//a[@href='https://www.linkedin.com/analytics/creator/content?timeRange=past_7_days&dimension=INDUSTRY&metricType=IMPRESSIONS']//div[@class='pcd-analytics-view-item']//p"));
        // get text of element displaying impressions Using Locator "XPath"
        // //span[@class='ca-entry-point__num-views t-14']
