...
public void endTest()
    ...
    public  void testCase01() throws InterruptedException{
        ...
        Thread.sleep(2000);
        // Click on the See All button for recommended movies Using Locator "XPath" //div[text()='See All ›']
        ...
        // getText() for the second movie name under premieres list Using Locator "XPath" //h2[text()='Premieres']/parent::div/parent::div/parent::div/following-sibling::div/div//div[2]//div[3]/div/div
        driver.navigate().back();
        WebElement premiere = driver.findElement(By.xpath("//h2[contains(text(),'Premieres')]/following::a[2]//div/div[3]/div[1]"));
        ...
        // getText() for the second movie language under premieres list Using Locator "XPath" //h2[text()='Premieres']/parent::div/parent::div/parent::div/following-sibling::div/div//div[2]//div[3]//div[2]/div
        WebElement lang = driver.findElement(By.xpath("//h2[contains(text(),'Premieres')]/following::a[2]//div/div[3]/div[2]"));
